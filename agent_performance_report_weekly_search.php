...
<?php
        $page_name = "agent_performance_report_weekly_search.php";
        $page_level = "0";
        $page_group_id = "0";
        $page_title = "Agent Performance Report Weekly Search";
        $page_menu_title = "Agent Performance Report Weekly Search";
?>
...
return popitup('agent_performance_report_weekly.php?fdate='+fdate+'&search_keyword='+search_keyword+'&tdate='+tdate);
}
...
<div style="font-family:Arial, Helvetica, sans-serif; color:#1D8895; font-size:22px; font-weight:bold; text-align:center; ">Agent Performance Weekly</div>
<div>
