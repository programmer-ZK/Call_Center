...
<?php
	$page_name = "customer_new";
	$page_title = "Add/Update Customer";
	$page_level = "2";
	$page_group_id = "1";
	$page_menu_title = "Add/Update Customer";
?>
<?php
				...
				<fieldset>
					...
					<ol>
                    	<li class="even">
							...
							<input id="txtcaller_id" name="txtcaller_id" value="<?php echo $caller_id;?>" disabled="disabled"/>
