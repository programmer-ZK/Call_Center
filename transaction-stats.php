   ...
   if($search_keyword == "conversion")
	{
		...
		$rs = $transaction_reports->get_records_conversion(addslashes($txtSearch), $recStartFrom=0, $total_records_count/*$page_records_limit*/, $field, $order, $fdate, $tdate, $search_keyword, $keywords, $isexport, $today);
	...
	if($search_keyword == "redemption")
	{
		...
		$rs = $transaction_reports->get_records_redemption(addslashes($txtSearch), $recStartFrom=0, $total_records_count/*$page_records_limit*/, $field, $order, $fdate, $tdate, $search_keyword, $keywords, $isexport, $today);
...
<div style="font-family:Arial, Helvetica, sans-serif; color:#1D8895; font-size:22px; font-weight:bold; text-align:center; ">Transactions Report</div>
	...
	<div class="box">
		    ...
		    <table class="table-short" style="background-color:#FFFFFF; margin-left:0px;width:auto;" >
      			<thead>
					<tr>
      				...
      				<tr>
					<td class="col-head2" style="width:23%;"><a href="<?php echo($page_name);?>?field=unique_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Tracking ID</a></td>
	        	        <td class="col-head2" style="width:15%;"><a href="<?php echo($page_name);?>?field=caller_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Caller ID</a></td>
						 <td class="col-head2" style="width:12%;"><a href="<?php echo($page_name);?>?field=customer_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Customer<br />ID</a></td>
						 <td class="col-head2" style="width:14%;"><a href="<?php echo($page_name);?>?field=trans_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Trans. ID</a></td>
		                <td class="col-head2" style="width:14%;"><a href="<?php echo($page_name);?>?field=date&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Date</a></td>
						<td class="col-head2"><a href="<?php echo($page_name);?>?field=time&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Time</a></td>
		               <!-- <td class="col-head2"><a href="<?php //echo($page_name);?>?field=Duration&order=<?php //echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php //echo $fdate; ?>&tdate=<?php //echo $tdate; ?>&keywords=<?php //echo $keywords; ?>&search_keyword=<?php //echo $search_keyword; ?>">Duration</a></td>-->
						 <td class="col-head2"><a href="<?php echo($page_name);?>?field=agent_name&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>&pgno=<?php echo $_REQUEST['pgno']; ?>">Agent Name</a></td>
        ...
        <div class="box-container" style="overflow:auto; height:600px;">  		
      		<table class="table-short">
				...
				<?php while(!$rs->EOF){ ?>
      				<tr class="odd">
                        <td class="col-first"><a title="click here to download" target="_blank" href="recording/<?php echo date('Ymd',strtotime($rs->fields["DATE"])).'/'.$rs->fields["userfield"]; ?>.wav" ><?php echo $rs->fields["unique_id"]; ?> </a></td>					<?php //if($rs->fields["status"] == "1"){ $pin_status = "SUCCESS"; }
