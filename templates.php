...
<?php
	...
	$page_title = "Templates List";
        $page_level = "2";
        $page_group_id = "1";
	$page_menu_title = "Templates List";
?>
...
<?php
	...
	//if($template == "email")
	//{
       		$rs = $templates->get_records(addslashes($txtSearch), $recStartFrom, $page_records_limit, $field, $order, $template);
	//}
	//else
	//{
...
<form name="listings" id="listings" action="templates.php" method="post" onsubmit="javascript:return Confirmation(this);" >
      		...
      		<table class="table-short">
				...
				<tr >
      			...
      			<tfoot>
					...
					<td colspan="5"><div class="align-right"><a href="templates_new.php?template=<?php echo $template; ?>" name="add_template" id="add_template" class="button"><span>Add Template</span></a> </div></td>
				...
				<td class="col-first"><?php echo $rs->fields["id"]; ?></td>
                        ...
                        <!--    <td ><?php //echo $rs->fields["password"]; ?> </td> -->
                                <td class="col-first"><?php echo $rs->fields["subject"]; ?> </td>
                                ...
                                <td class="row-nav"> <a href="templates_new.php?template=<?php echo $template; ?>&template_id=<?php echo $tools_admin->encryptId($rs->fields["id"]); ?>" class="table-edit-link"></a></td>
                                <td class="row-nav">
                                         <?php if(!empty($rs->fields["status"])){ ?>
                                         <a href="templates_delete.php?template_id=<?php echo $tools_admin->encryptId($rs->fields["id"]); ?>&template=<?php echo $template; ?>" class="table-delete-link" alt = "Delete"></a>
                                         <?php  } else {?> &nbsp;
                                         <?php  } ?>
