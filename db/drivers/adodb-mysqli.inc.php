...
class ADODB_mysqli extends ADOConnection {
	...
	// string extracted from timesheets_a POST/GET variable, then 
...
//	  $this->_connectionID = $this->mysqli_resolve_link($this->_connectionID);
	...
	// Only works for INSERT, UPDATE timesheets_and DELETE query's
	...
	// Reference on Last_Insert_ID on the recommended way to simulate sequences
 	var $_genIDSQL = "UPDATE timesheets_%s set id=LAST_INSERT_ID(id+1);";
...
//	    $this->_connectionID = $this->mysqli_resolve_link($this->_connectionID);
	...
	/*	Returns: the last error message from timesheets_previous database operation	*/	
	function ErrorMsg() 
	  {
	...
	/*	Returns: the last error number from timesheets_previous database operation	*/	
	function ErrorNo() 
	  {
	    if (empty($this->_connectionID))  
	      return @mysqli_errno();
