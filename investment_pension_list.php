      		...
      		<table class="table-long">
				...
				<tr >
					...
					<td class="col-head" >Col1</td>
      					<td class="col-head2" ><a href="<?php echo($page_name);?>.php?field=admin_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>">Account No</a></td>
	        	                <td class="col-head2"><a href="<?php echo($page_name);?>.php?field=admin_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>">Solution Type</a></td>
        	        	<!--    <td >Password</td> -->
		                        <td class="col-head2"><a href="<?php echo($page_name);?>.php?field=admin_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>">Types of Units</a></td>
                		        <td class="col-head2"><a href="<?php echo($page_name);?>.php?field=admin_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>">Product_type</a></td>
		                        <td class="col-head2"><a href="<?php echo($page_name);?>.php?field=admin_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>">Coverage</a></td>
		                        <td class="col-head2"><a href="<?php echo($page_name);?>.php?field=admin_id&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>">Requested Sum Insured</a></td>
		                        <td class="col-head2">Retirement Age</td>
		                        <td class="col-head2">Volatality</td>
				...
				<td class="col-first"><?php echo $rs->fields["account_no"]; ?></td>
                                <td class="col-first"><?php echo $rs->fields["solution_type"]; ?> </td>
                        <!--    <td ><?php //echo $rs->fields["password"]; ?> </td> -->
                                <td class="col-second"><?php echo $rs->fields["types_of_units"]; ?> </td>
                                <td class="col-first"><?php echo $rs->fields["product_type"]; ?> </td>
                                <td class="col-first"><?php echo $rs->fields["coverage"]; ?> </td>
                                <td class="col-first"><?php echo $rs->fields["requested_sum_insured"]; ?> </td>
