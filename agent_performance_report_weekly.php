...
<?php
	$page_name = "agent_performance_report_weekly.php";
	$page_title = "Agent Performance Report Weekly ";
	$page_level = "2";
	$page_group_id = "1";
	$page_menu_title = "Agent Performance Report Weekly";
?>
...
$ScoredWeeks = 0;
$html = '';
$html2 = "<br><table style='background-color:#E8E8DD; border-style:solid; border-color:#3A4043;' cellspacing='2' cellpadding='2' width='60%'>
			<tr>
				<th width='30%'>
				<font size='2' face='Verdana, Arial, Helvetica, sans-serif'>OVERALL SCORE</font>
				</th>
				<th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th>
			</tr>
			<tr>
				<th width='30%'>&nbsp;</th><th width='14%'>Week 1</th><th width='14%'>Week 2</th><th width='14%'>Week 3</th><th width='14%'>Week 4</th><th width='14%'>&nbsp;</th>
			</tr>";
    ...
    for($iLoop=1;$iLoop<=4;$iLoop++)
    {
		...
		if ($result) $html .= "</table></td>";
			...
			for ($i=1; $i<=4; $i++)
			{
				...
				$html .= "</table></td>";
				//$WeekSum[$i-1] = round(($WeekTotal)/$group_count);
		...
		$html .= "<tr>
		<td colspan='3'><font size='2' face='Verdana, Arial, Helvetica, sans-serif'><b>" .$group_name . "</b></td></tr>";
		//echo "<tr><td>&nbsp;</td>";
		...
		for($k=0;$k<=3;$k++)
		{
			...
			<tr>
			<td>&nbsp;</td>
			<td><font size='2' face='Verdana, Arial, Helvetica, sans-serif'>Week ".($k+1)."</font></td>
...
//		$html .= "<tr><td>&nbsp;</td><td>&nbsp;</td><td><b><font size='2' face='Verdana, Arial, Helvetica, sans-serif'>".round($MonthTotal/$ScoredWeeks)."</b></font></td></tr>";

/********************************hk******************************************/
		//Divide by fixed number of weeks in this case 4
		$html .= "<tr><td>&nbsp;</td><td>&nbsp;</td><td><b><font size='2' face='Verdana, Arial, Helvetica, sans-serif'>".round($MonthTotal/4)."</b></font></td></tr>";
/********************************hk******************************************/
		...
		//$html .= '<img class="graph" src="data:image/png;base64,' . base64_encode($imgbinary) . '" />';
		//$html .= "<img src='graphs/".$group_name.".png' /></td></tr>";
		//$html .= "</table>"; //graph table close
