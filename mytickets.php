...
<?php
 ...
 //print_r($printme);
	...
	$page_name = "mytickets.php";
	$page_title = "My Tickets";
	$page_level = "4";
	$page_group_id = "1";
	$page_menu_title = "My Tickets";
?>
...
$tickets = ClientInfo::getAgentTickets($startpoint,$per_page,$agent_id,$fdate,$tdate,$curren_status,$frdate,$trdate);
  ...
  <tr>
    <td colspan="6">
     <div class="pagination"><ul>
       <?php echo pagination($per_page=50,$page,$found_rows->fields,$agent_id,$fdate,$tdate,$curren_status,'mytickets.php?fdate='.$fdate.'&tdate='.$tdate.'&status='.$curren_status.'&frdate='.$frdate.'&trdate='.$trdate.'&');
