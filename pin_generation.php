...
<?php
		...
		if($_REQUEST['action'] == "pgen"){
			...
			$user_pin->user_outbound_hangup_no($unique_id);
		}
...
<?php include($site_root."includes/header.php"); ?>
		...
		<h4 class="white"><?php echo($page_title); ?></h4>
			...
			?>
				<h3>Please Transfer the call to *11 for Pin Generation </h3>
	...
	<?php } 
		  ...
		  { 
			...
			?>
				<h3>Please Transfer the call to *33 for Pin Reset </h3>
			<?php 
		  }
		  else if($_REQUEST['action'] == "pver")
		  { 
		  ...
		  ?>
				...
				<h3>Please Transfer the call to *22 for Pin Verification </h3>
			<?php 
		  } 
		  else if($_REQUEST['action'] == "pchn")
		  { 
		  ...
		  ?>
				...
				<h3>Please Transfer the call to *44 for Pin change </h3>
			<?php 
		  } ?>
