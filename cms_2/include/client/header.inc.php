<?php
$title=($cfg && is_object($cfg) && $cfg->getTitle())? $cfg->getTitle() : __('Complaint Management System');
...
<head>
    ...
    <meta name="keywords" content="Ticket, Customer support system, support ticket system">
