...
define('SECRET_SALT','n8NIOTtiALfkg2976iDkCiNYRQ8E6AMV');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','hafeez@convexinteractive.com');
...
#
# > create user ticket;
# > grant all on ticket.* to ticket require subject '<subject>';
#
...
# outside the control of both Ticket development and many server
# administrators, this option can be adjusted for your setup. Many folks who
# experience blank or garbled email from Ticket can adjust this setting to
...
#
# If you have a strange HTTP server configuration and Ticket cannot
# discover the URL path of where your Ticket is installed, define
# ROOT_PATH here.
#
# The ROOT_PATH is the part of the URL used to access your Ticket
...
#
# Ticket supports Memcache as a session storage backend if the `memcache`
