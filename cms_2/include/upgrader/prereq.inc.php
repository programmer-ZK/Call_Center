...
?>
<h2><?php echo __('Ticket Upgrader');?></h2>
<div id="upgrader">

    <div id="main">
            <div id="intro">
             <p><?php echo __('Thank you for being a loyal Ticket user!');?></p>
            ...
            <p><?php echo __("Before we begin, we'll check your server configuration to make sure you meet the minimum requirements to run the latest version of Ticket.");?></p>
            <h3><?php echo __('Prerequisites');?>: <font color="red"><?php echo $errors['prereq']; ?></font></h3>
            <?php echo __('These items are necessary in order to run the latest version of Ticket.');?>
            <ul class="progress">
    ...
    <div id="sidebar">
            ...
            <p>1. <?php echo __('Remember to back up your Ticket database');?></p>
            <p>2. <?php echo sprintf(__('Refer to %1$s Upgrade Guide %2$s for the latest tips'), '<a href="http://ticket.com/wiki/Upgrade_and_Migration" target="_blank">', '</a>');?></p>
            <p>3. <?php echo __('If you experience any problems, you can always restore your files/database backup.');?></p>
            <p>4. <?php echo sprintf(__('We can help, feel free to %1$s contact us %2$s for professional help.'), '<a href="http://ticket.com/support/" target="_blank">', '</a>');?></p>
...
<div id="loading">
    ...
    <?php echo __('Please wait... while we upgrade your Ticket installation!');?>
    <div id="msg"></div>
</div>
