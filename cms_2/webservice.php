...
if(IsNullOrEmptyString($config['key']) || ($config['key'] === '73D26BD41B7377DD0F721091A283D822'))  {
...
$data = array(
    'name'      =>      'Hafeez',  // from name aka User/Client Name
    'email'     =>      'hafeez@gmail.com',  // from email aka User/Client Email
	'phone' 	=>		'123456333',  // phone number aka User/Client Phone Number
    'subject'   =>      'test subject aka Issue Summary',  // test subject, aka Issue Summary
    'message'   =>      'test ticket body, aka Issue Details',  // test ticket body, aka Issue Details.
    'ip'        =>      $_SERVER['REMOTE_ADDR'],
	 // Should be IP address of the machine thats trying to open the ticket.
...
array('file.txt' =>
        'data:text/plain;base64;'
            .base64_encode(file_get_contents('http://localhost/osticket/file.txt')));  // replace ./file.txt with /path/to/your/test/filename.txt
...
echo "Ticket No. ".$ticket_id = (int) $result." has been added successfully.";
