...
<?php
        $page_name = "product_wise_pie_chart.php";
        $page_level = "0";
        $page_group_id = "0";
        $page_title = "Product Wise Pie Chart";
        $page_menu_title = "Product Wise Pie Chart";
?>
...
<?php $rs_agent_name = $admin->product_wise_pie_chart($fdate,$tdate);
$product_wise_pie_chart="";
...
<!-- ******************************  Agent On Call and Busy Times ************************** -->
	...
	<table class="table-short" id="keywords">
      			<thead>
      				<!--<tr>
	        	     <th colspan="3"><center><h4>Product Wise Pie Chart</h4></center></th>
					</tr>-->
      			</thead>
      			<tbody>
                <tr>
                ...
                <?php  $product_wise_pie_chart .= "['".trim($rs_agent_name->fields['product'])."',".($rs_agent_name->fields['rec'])."]," ?>  
                <?php 
				$rs_agent_name->MoveNext();
				}   ?>
                  <div id="product_wise_pie_chart"></div>    
                </td>
                </tr>
                 </tr>
...
$(document).ready(function(){
	...
	$('.hideme').hide();
	$('#product_wise_pie_chart').show().printElement();	
	$('.hideme').show();
	});
...
anychart.onDocumentReady(function() {
  ...
  chart = anychart.pie([<?php echo $product_wise_pie_chart;?>]);
  // set container id for the chart
  chart.container('product_wise_pie_chart');
  // set chart title text settings
  chart.title('Product Wise Pie Chart');
