...
if (isset($_REQUEST['login'])) {
  ...
  if ((($no < $limit_of_login_users)  && ($result2->fields['designation'] == 'Agents')) || ($result2->fields['designation'] == 'Supervisor')) {
    ...
    echo "<form action=\"cms/checkusers.php\" method=\"post\" id=\"loginForm\">
...
?>
  <tr class="msg">
    <td colspan="2"><?php echo $_SESSION[$db_prefix . '_GM'];
                    unset($_SESSION[$db_prefix . '_GM']); ?></td>
  </tr>
<?php
} else {
} ?>
...
<div class="main_header">
  <div id="container">
    <div id="header">
      <div id="top">
        <h1><a href="index.php"><img src="nelogo.png" alt="RNI" style="width: 250px;" /></a></h1>
        ...
        <ol>
              ...
              <div class="box">
                <div id="message-green">
                  <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="green-left"><?php echo $_SESSION[$db_prefix . '_GM'];
                                              unset($_SESSION[$db_prefix . '_GM']); ?></td>
          ...
          <li>
            ...
            <?php if ($userr_login == '1') { ?>
              <label class="remember">
                <font color="red" style="font-weight:normal">No. of Login Users Exceeds</font>
              </label>
            <?php } elseif (isset($_REQUEST['msg'])) { ?>
              <label class="remember">
                <font color="red" style="font-weight:normal"> <?php echo $_REQUEST['msg']; ?></font>
              </label>
            <?php  }  ?>
          </li>
