...
<?php
        $page_name = "off-time-stats";
        $page_level = "0";
        $page_group_id = "0";
        $page_title = "Off Time Stats";
        $page_menu_title = "Off Time Stats";
?>
...
<?php	
	...
	$rs = $admin->get_off_time_stats(addslashes($txtSearch), $recStartFrom, $page_records_limit, $field, $order, $fdate, $tdate);
?>
...
<!--      			<thead>
				...
				<?php 
				$stringData .= $rs->fields["clid"].", ".$rs->fields["time"].", ".$rs->fields["date"]."\r\n"; 
