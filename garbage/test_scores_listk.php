...
<div id="mid-col" class="mid-col">
	<div class="box">
		...
		<table class="table-short" style="background-color:#FFFFFF; margin-left:0px;width:auto;">
		      <thead>
					<tr>
						<td class="col-head2" style="width:20%;">Agent Name</td>
						<td class="col-head2" style="width:14%;">Test Code</td>
						<td class="col-head2" style="width:18%;">Test Score(%)</td>
						<td class="col-head2" style="width:18%;">Test Date</td>
