...
function popitup2(url) {
	...
	newwindow=window.open(url,'name','height=660,width=450');
      		...
      		<table class="table-short">
      			<thead>
					...
					<?php if($search_keyword == "out_bound")
						{ ?>
	        	        <td class="col-head2"><a href="<?php echo($page_name);?>?field=dst&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Called ID</a></td>
						<?php }else { ?>
							<td class="col-head2"><a href="<?php echo($page_name);?>?field=clid&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Caller ID</a></td>
						<?php } ?>
	...
	<td class="col-head2"><a href="<?php echo($page_name);?>?field=uniqueid&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Evaluation Status</a></td>
				...
				<?php while(!$rs->EOF){ ?>
					...
					<?php if($search_keyword == "out_bound")
						...
						<td class="col-first"><?php echo substr($rs->fields["call_type"],0,1); ?> </td>						<?php
							//echo $rs->fields["uniqueid"];
							 if ($cc_evaluation->is_score_exist($rs->fields["uniqueid"]) == true)
							 {
								...
								$link_call_id = "javascript:return popitup('calc_eval.php?unique_id=".$rs->fields["uniqueid"]."&evaluate_agent_id=".$rs->fields["agent_id"]."&evaluated=true');";
							 }
							 else
							 {
							 	$call_eval_status = "Not Evaluated";
							 	$link_call_id = "javascript:return popitup('calc_eval.php?unique_id=".$rs->fields["uniqueid"]."&evaluate_agent_id=".$rs->fields["agent_id"]."');";
							 }
						?>
