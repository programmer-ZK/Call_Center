...
class Ticket2PDF extends mPDF
{
    ...
    function _print() {
		...
		$this->WriteCell($l, 7, __('Product'), 1, 0, 'L', true);
        $this->SetFont('');
        $this->WriteCell($c, 7, $ticket->ht['product'], 1, 0, 'L', true);
		
		$this->SetFont('Arial', 'B', 11);
        $this->WriteCell($l, 7, __('Nature'), 1, 0, 'L', true);
        $this->SetFont('');
        $this->WriteCell($c, 7, $ticket->ht['nature'], 1, 1, 'L', true);
	   ...
	   /*
        ...
        $this->SetFont('');
        $this->WriteCell($c, 7, $ticket->getDeptName(), 1, 1, 'L', true);
	   ...
	   $this->SetFont('Arial', 'B', 11);
      /*  if($ticket->isOpen()) {
            $this->WriteCell($l, 7, __('Due Date'), 1, 1, 'L', true);
            $this->SetFont('');
            $this->WriteCell($c, 7, Format::db_datetime($ticket->getEstDueDate()), 1, 1, 'L', true);
        } else {
            $this->WriteCell($l, 7, __('Close Date'), 1, 1, 'L', true);
            $this->SetFont('');
            $this->WriteCell($c, 7, Format::db_datetime($ticket->getLastMsgDate()), 1, 0, 'L', true);
        }*/
