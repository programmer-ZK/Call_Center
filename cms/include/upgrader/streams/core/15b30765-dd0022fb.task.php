...
/*********************************************************************
    ...
    database-backed attachments in Ticket v1.7. This class provides the
...
class AttachmentMigrater extends MigrationTask {
    ...
    // This is the AttachmentFile::save() method from Ticket 1.7.6. It's
    // been ported here so that further changes to the %file table and the
    // AttachmentFile::save() method do not affect upgrades from Ticket
    // 1.6 to Ticket 1.8 and beyond.
