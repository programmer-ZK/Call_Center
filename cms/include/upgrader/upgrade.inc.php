...
?>
    <h2><?php echo sprintf(__('Migrate to Ticket %s'), THIS_VERSION); ?></h2>
<div id="upgrader">
    <div id="main">
            <div id="intro">
             <p><?php echo __('Thank you for taking the time to upgrade your Ticket intallation!');?></p>
            ...
            <p><?php echo __('In order to upgrade to this version of Ticket, a database migration is required. This upgrader will automatically apply the database patches shipped with Ticket since your last upgrade.'); ?></p>
    ...
    <div id="sidebar">
            ...
            <p>3. <?php echo sprintf(__('We can help. Feel free to %1$s contact us %2$s for professional help.'), '<a href="http://ticket.com/support" target="_blank">', '</a>');?></p>
    </div>
    <div class="clear"></div>
    <div id="upgrading">
