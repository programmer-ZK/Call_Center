...
<div id="upgrader">
   <div id="main">
    ...
    <div id="intro">
        ...
        <p><?php echo sprintf(__('Please note the error(s), if any, when %1$s seeking help %2$s.'),'<a target="_blank" href="http://ticket.com/support/">','</a>');?><p>
        <?php
        ...
        <br>
        <p><?php echo sprintf(__('Please refer to the %1$s Upgrade Guide %2$s for more information.'), '<a target="_blank" href="http://ticket.com/wiki/Upgrade_and_Migration">', '</a>');?></p>
    </div>
    <p><strong><?php echo __('Need Help?');?></strong> <?php echo sprintf(__('We provide %1$s professional upgrade services %2$s and commercial support.'), '<a target="_blank" href="http://ticket.com/support/professional_services.php"><u>','</u></a>'); echo sprintf(__('%1$s Contact us %2$s today for <u>expedited</u> help.'), '<a target="_blank" href="http://ticket.com/support/">','</a>');?></p>
  </div>
  <div id="sidebar">
    <h3><?php echo __('What to do?');?></h3>
    <p><?php echo sprintf(__('Restore your previous version from backup and try again or %1$s seek help %2$s.'), '<a target="_blank" href="http://ticket.com/support/">','</a>');?></p>
  </div>
  <div class="clear"></div>
</div>
