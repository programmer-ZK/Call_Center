    ...
    <tr>
        ...
        <div class="extra_drp">
            <span class="action-button pull-right" data-dropdown="#action-dropdown-more">
                ...
                <span ><i class="icon-cog"></i> <?php echo __('Mores'); ?></span>
            </span>
        ...
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                ...
                <tr>
                  ...
                  <?php /* ?>
                   <tr>
                     <th ><?php echo __('Register Number');  ?>:</th>
                     <td ><?php echo ($user->getRegiserNum())? $user->getRegiserNum():"N/A"; ?></td>
                   </tr>
                   <?php */?>
                    <tr>
                     <th ><?php echo __('CNIC'); ?>:</th>
                     <td ><?php echo ($user->getCNIC())? preg_replace('~.*(\d{5})[^\d]*(\d{7})[^\d]*(\d{1}).*~', 
                '$1-$2-$3'." \n",$user->getCNIC()):"N/A"; ?></td>
                    </tr>
                        <?php if($user->getCMID()){ ?>
                   <tr>
                     <th ><?php echo __('CMID');  ?>:</th>
                     <td ><?php echo ($user->getCMID())? $user->getCMID() :"N/A"; ?></td>
                   </tr>
                   <?php } ?>
                  ...
                  <?php if($user->getUIN()){ ?>
                   <tr>
                     <th ><?php echo __('CMID');  ?>:</th>
                     <td ><?php echo ($user->getUIN())? $user->getUIN() :"N/A"; ?></td>
                   </tr>
                   <?php } ?>
                   <tr>
                     <th ><?php echo __('Phone');  ?>:</th>
                     <td ><?php echo ($user->getPhoneNumber())? $user->getPhoneNumber() :"N/A"; ?></td>
                   </tr>
                  </td>
                </tr>
                ...
                <?php foreach ($entry->getAnswers() as $a) {
                    if(!empty($a->display())){ ?>
                    <tr>
                    <th ><?php echo Format::htmlchars($a->getField()->get('label'));
                         ?>:</th>
