...
?>
    ...
    <tr>
     <td style="width:30%;"><?php echo Format::htmlchars('CNIC Number');?>:</td>
     <td><?php echo preg_replace('~.*(\d{5})[^\d]*(\d{7})[^\d]*(\d{1}).*~', '$1-$2-$3'." \n",$user->getCNIC()); ?></td>
    </tr>
    <?php if($user->getCMID()){ ?>
     <tr>
     <td style="width:30%;"><?php echo Format::htmlchars('CMID');?>:</td>
     <td><?php echo $user->getCMID(); ?></td>
    </tr> 
    <?php } ?> 
     <?php if($user->getUIN()){ ?>
     <tr>
     <td style="width:30%;"><?php echo Format::htmlchars('UIN');?>:</td>
     <td><?php echo $user->getUIN(); ?></td>
    </tr> 
    <?php } ?>   
    <!-- hbm -->
