...
<table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr style="display:none;"><td><?php echo __('Registration Required'); ?>:</td>
        ...
        <tr style="display:none;"><td><?php echo __('Registration Method'); ?>:</td>
...
<?php foreach (array(
    ...
    as $key=>$val) { ?>
        ...
        <tr style="display:none;"><td><?php echo __('User Excessive Logins'); ?>:</td>
            <td>
        ...
        <tr style="display:none;"><td><?php echo __('User Session Timeout'); ?>:</td>
            <td>
        ...
        <tr style="display:none;"><td><?php echo __('Client Quick Access'); ?>:</td>
