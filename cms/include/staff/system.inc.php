...
?>
<h2><?php echo __('About this Ticket Installation'); ?></h2>
<br/>
...
<tbody>
    <tr><td><?php echo __('Ticket Version'); ?></td>
...
?>
      <a class="green button action-button pull-right"
         href="http://ticket.com/download?cv=<?php echo $cv; ?>"><i class="icon-rocket"></i>
...
if (!$lv) { ?>
    <strong> — <?php echo __('This Ticket version is no longer supported. Please consider upgrading');
        ?></strong>
<?php
}
?>
