...
if($_REQUEST['a']=='add'){
    $sql = 'SELECT count(staff_id) from ts_staff';
    $res= db_query($sql, false);
    $total = db_result($res);
    if($total==40){ ?>
       <script type="text/javascript"> window.location.href="staff.php?limit=max"; </script> 
    <?php }
}
$info = $qs = array();
 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <input type="text" size="30" required class="staff-username typeahead"
        ...
        <tr>
            ...
            <td>
                <input type="text" size="30" required name="firstname" class="auto first"
        ...
        <tr>
            ...
            <td>
                <input type="text" size="30" required name="lastname" class="auto last"
        ...
        <tr>
            ...
            <td>
                <input type="text" size="30" required name="email" class="auto email"
...
<?php } ?>
	...
	<?php if($_REQUEST['a']!='add'){?>	
    <tbody id="password-fields" style="<?php  if ($info['welcome_email'] || ($info['backend'] && $info['backend'] != 'local')){ echo 'display:none;'; } ?>">
 ...
 <?php }else{ ?>
  <tbody id="password-fields" style="
 <?php
	   ...
	   // echo 'display:none;'; ?> ">
        ...
        <tr>
            ...
            <td>
                <input type="password" size="18" name="passwd1" required value="<?php echo $info['passwd1']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['passwd1']; ?></span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="password" size="18" name="passwd2" required value="<?php echo $info['passwd2']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['passwd2']; ?></span>
            </td>
        </tr>
