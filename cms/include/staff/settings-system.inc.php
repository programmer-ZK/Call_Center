...
$gmtime = Misc::gmtime();
?>
<h2><?php echo __('System Settings and Preferences');?> <!-- - <span class="ltr">CRM(<?php //echo $cfg->getVersion(); ?>)</span> --></h2>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;<font class="error"><?php echo $config['isoffline']?'Ticket '.__('Offline'):''; ?></font>
