...
<form action="groups.php?<?php echo Http::build_query($qs); ?>" method="post" id="save" name="group">
 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr style="display:none;"><td><?php echo __('Can Ban Emails');?></td>
            <td>
        ...
        <tr style="display:none;"><td><?php echo __('Can Manage Premade');?></td>
            <td>
        ...
        <tr style="display:none;"><td><?php echo __('Can Manage FAQ');?></td>
            <td>
