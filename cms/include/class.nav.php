...
class StaffNav {
    ...
    function getTabs(){
        if(!$this->tabs) {
            $this->tabs=array();
            $this->tabs['dashboard'] = array('desc'=>__('Dashboard'),'href'=>'#','title'=>__('Agent Dashboard'), "class"=>"no-pjax");
           //  $this->tabs['users'] = array('desc' => __('Users'), 'href' => 'users.php', 'title' => __('User Management'));
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'dashboard':
                    ...
                    //$subnav[]=array('desc'=>__('Agent Management'),'href'=>'directory.php','iconclass'=>'teams');
                    $subnav[]=array('desc'=>__('My Profile'),'href'=>'profile.php','iconclass'=>'users');
                    break;
                case 'users':
                    $subnav[] = array('desc' => __('User Management'), 'href' => 'users.php', 'iconclass' => 'teams');
                    //$subnav[] = array('desc' => __('Organizations'), 'href' => 'orgs.php', 'iconclass' => 'departments');
                    //$subnav[] = array('desc' => __('Search Client'), 'href' => 'orgs.php', 'iconclass' => 'departments');
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                case 'dashboard':
					...
					$subnav[]=array('desc'=>__('Agent Login Activity'),'href'=>'staff_logs.php','iconclass'=>'teams');
