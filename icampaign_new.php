    ...
    if($flag == true){
        ...
        if($_FILES["file"]["size"] >= 0 ){
            if( move_uploaded_file($_FILES["file"]["tmp_name"],"$folder"."/".$_FILES["file"]["name"])){
                ...
                $campaign_id = $campaign->create_campaign($cname,$cnature,$agent,$start_datetime,$end_datetime,$ischeme,$campaign_script,$campaign_status,$_SESSION[$db_prefix.'_UserId']);
                $i=0;
                while($i<=$num){
                ...
                $_SESSION[$db_prefix.'_GM'] = "".$cname." Campaign Created Successfully.";
