...
<?php
$page_name = "out-bound-calls.php";
$page_level = "0";
$page_group_id = "0";
$page_title = "Outbound Calls Report";
$page_menu_title = "Outbound Calls Report";
?>
...
<body>
	...
	<div>
		...
		<?php if (!empty($_REQUEST['fdate']) && !empty($_REQUEST['tdate'])) {
			...
			if ($page <= 0) $page = 1;
			$per_page = 5000; // Set how many records do you want to display per page.
		...
		?>
			<div id="agent_pd_report">
				<?php $rs_agent_name = $admin->out_bound_calls_report($search_keyword, $fdateTime, $tdateTime, $startpoint, $per_page);
						...
						<tbody>
							...
							while (!$rs_agent_name->EOF) { ?>
								<tr class="odd">
									...
									<td><?php if($rs_agent_name->fields['call_status'] == 'ANSWERED'){ 
									echo 'Successfull';
									}
									else{
									echo 'Unsuccessfull';
