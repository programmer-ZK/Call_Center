...
/*if(isset($_REQUEST['export']))
{
                                ...
                                $rs = $cc_evaluation->iget_records(addslashes($txtSearch), $recStartFrom, $page_records_limit, $field, $order, $fdate, $tdate, $search_keyword, $keywords, 0, $today);
								...
								$heading = "Called ID, Caller ID, Call Status, Call Type, Tracking ID , Date, Time, Duration, Agent Name\r\n";
...
if(isset($_REQUEST['export_pdf']))
{
								...
								$tools_admin->generatePDF($db_export_fix, 'L', 'mm', 'A3', 'Arial', 10, 'Call_Record.pdf', 'D', 40, 7, 1);
								exit();
}*/
...
if(isset($_REQUEST['export']))
{
	...
	$stringData2 = str_replace('</tag2>',null,$stringData2 );
	//$stringData2 = preg_replace('/[^a-zA-Z0-9]/s', '', $stringData2);
	$db_export_fix = $site_root."download/Call_Evaluation.csv";
	//echo $stringData2; exit;
...
$rs = $cc_evaluation->iget_records(addslashes($txtSearch), $recStartFrom, $page_records_limit, $field, $order, $fdate, $tdate, $search_keyword, $keywords, 1, $today);
?>
		...
		<table class="table-short" style="background-color:#FFFFFF; margin-left:0px;width:auto;">
				<thead>
					...
					<?php if($search_keyword == "out_bound")
						{ $stringData2 .= "<tag2>Called ID<tag2>,";?>
	        	        <td class="col-head2" style="width:22%;"><a href="<?php echo($page_name);?>?field=dst&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Called ID</a></td>
						<?php }else { $stringData2 .= "<tag2>Caller ID</tag2>,";?>
							<td class="col-head2" style="width:22%;"><a href="<?php echo($page_name);?>?field=clid&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Caller ID</a></td>
						<?php } ?>
						
						<?php $stringData2 .= "<tag2>Duration</tag2>,<tag2>Agent Name</tag2>,<tag2>Call Type</tag2>,<tag2>Call ID</tag2>,<tag2>Evaluation Status</tag2>,<tag2>Work Code</tag2>\r\n";?>
		                ...
		                <td class="col-head2" style="width:12%;"><a href="<?php echo($page_name);?>?field=Duration&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Duration</a></td>
						 <td class="col-head2" style="width:12%;"><a href="<?php echo($page_name);?>?field=agent_name&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Agent<br>Name</a></td>
						 <td class="col-head2" style="width:12%;"><a href="<?php echo($page_name);?>?field=call_type&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Call<br>Type</a></td>
						<td class="col-head2" style="width:18%;"><a href="<?php echo($page_name);?>?field=uniqueid&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Call ID</a></td>
						<td class="col-head2"><a href="<?php echo($page_name);?>?field=uniqueid&order=<?php echo(($_REQUEST["order"]=="asc")?"desc":"asc");?>&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&keywords=<?php echo $keywords; ?>&search_keyword=<?php echo $search_keyword; ?>">Work<br>Code</a></td>
      		...
      		<table class="table-short">
				...
				<?php while(!$rs->EOF){ ?>
					...
					<?php if($search_keyword == "out_bound")
						...
						<?php }else {  $stringData2 .= $rs->fields['clid'].",";?>
						...
						<?php } ?>
					   	<?php $stringData2 .= $rs->fields['Duration'].",".$rs->fields['agent_name'].",".substr($rs->fields['call_type'],0,1).",".$rs->fields['uniqueid'];?> 
						...
						<td class="col-first"><?php echo substr($rs->fields["call_type"],0,1); ?> </td>
                                                <?php
							//echo $rs->fields["uniqueid"];
							 if ($cc_evaluation->is_score_exist($rs->fields["uniqueid"]) == true)
							 {
							 	$stringData2 .= ",Evaluated";
							 	$call_eval_status = "Evaluated";
								//$link_call_eval_status = "javascript:return popitup('call_scoring_report.php?unique_id=".$rs->fields["uniqueid"]."');";
								$link_call_eval_status = "javascript:return popitup('call_scoring_report.php?unique_id=".$rs->fields["uniqueid"]."&agent_name=".$rs->fields["agent_name"]."&duration=".$rs->fields["Duration"]."&call_type=".$rs->fields["call_type"]."&calldate=".$rs->fields["calldate"]."');";
								$link_call_id = "javascript:return popitup('calc_eval.php?unique_id=".$rs->fields["uniqueid"]."&evaluate_agent_id=".$rs->fields["agent_id"]."&evaluated=true&duration=".$rs->fields["Duration"]."&call_type=".$rs->fields["call_type"]."');";
							 }
							 else
							 {
							 	$stringData2 .= ",Not Evaluated";
							 	$call_eval_status = "Not Evaluated";
							 	$link_call_id = "javascript:return popitup('calc_eval.php?unique_id=".$rs->fields["uniqueid"]."&evaluate_agent_id=".$rs->fields["agent_id"]."&duration=".$rs->fields["Duration"]."&call_type=".$rs->fields["call_type"]."&calldate=".$rs->fields["calldate"]."');";
							 }
						?>
						<td class="col-first"><a href="" onclick="<?php echo $link_call_id;?>" ><?php echo $rs->fields["uniqueid"]; ?></a></td>
						<?php 						
						$rsw = $user_tools->get_call_workcodes($rs->fields['uniqueid']);
						$i = 1;
						$workcodes = "";
						$workcodes2 = "";
						while (!$rsw->EOF){
