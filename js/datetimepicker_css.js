...
var CalPosOffsetX = -30; //X position offset relative to calendar icon, can be negative value
var CalPosOffsetY = -210; //Y position offset relative to calendar icon, can be negative value

//Configurable parameters start
var SpanBorderColor = "#000000";//span border color
var SpanBgColor = "#FFFFFF"; //span background color
var MonthYearColor = "#1D8895"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#3A4043"; //var WeekHeadColor="#18861B";//Background Color in Week header.3A4043
var SundayColor = "#A1B1B3"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#A1B1B3"; //Background color of Saturday.
var WeekDayColor = "#F2F2F2"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#ffbd35"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#1D8895"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#E0FF38"; //color when mouse move over.
var DisableColor = "#999966"; //color of disabled cell.
var CalBgColor = "##F2F2F2"; //Background color of Calendar window.
