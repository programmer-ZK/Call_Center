...
<!-- *********************************************************************************** -->
                ...
                <?php
					   ...
					   //echo $B;
                       // $C=$tools_admin->sub_the_time($sum_worktime,$B);
					    $C=$tools_admin->sum_the_time_2($sum_worktime,$B);
					   // echo 'C :'.$C;
						//die;
                        //$C=$tools_admin->sub_the_time($A,$B);
                        // echo $C."sub";
                        $G=$tools_admin->sum_the_time($D,$E); //echo $G."DE";
                        $G=$tools_admin->sum_the_time($G,$F); //echo $G."GF";
                        $H=$tools_admin->sum_the_time_2($C,$G); //echo $H.'H';
						//echo "farhan".$sum_worktime.'--'.$B;
                        //echo $C;
                		//echo "<br/>";
                	   //echo $G;
                ?>
