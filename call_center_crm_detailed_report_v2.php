...
<?php
        $pageName = 'call_center_crm_detailed_report.php';
        $page_level = "0";
        $page_group_id = "0";
...
<div id="mid-col" class="mid-col">
	<div class="box">
	 <center><h4>Call Center Detailed Crm Report</h4></center>
	<h4 class="white">
...
if ($page <= 0) $page = 1;
   ...
   //print_r($_REQUEST);
 $rs_agent_name = $admin->callcenter_crm_detailed_report_v2($startpoint,$per_page,$fdate,$tdate,$product_id,$priority_id,$status_id,$search_keyword,$location,$natures,$intime_over_due,$depart,$sec,$frdate,$trdate,$compalaint_id);
 $found_rows = $admin->found_rows(); 
 $actions =array('A'=>'Assigned','E'=>'Edit','R'=>'Reply','SA'=>'Self Assigned','SC'=>'Status Changed','RA'=>'Re Assigned');
  $status =array(1=>'Open',2=>'Resolved',3=>'Closed',6=>'Irrelevant');
 ?>
	...
	<table id="keywords" >
      			<thead>
                    <tr>
                     ...
                     <th><span>Current: In-Time/Over-due</span> </th>
					</tr>
      			</thead>
      			<tbody>
				...
				// $var_date=date('Y-m-d H:i:s');
				 ...
				 ?>
                       ...
                       <td><?php //if($rs_agent_name->fields['status_id']==2 || $rs_agent_name->fields['status_id']==3 ){
						    if($rs_agent_name->fields['name']=="Closed" ){
                     ...
                     <!--  <td><?php   // && $rs_agent_name->fields['action_type']!="E" //echo ($admin->dateDiff($rs_agent_name->fields['created'],$rs_agent_name->fields['response_time']))?$rs_agent_name->fields['response_datetime']:"--";?></td>-->
					  ...
					  //if($rs_agent_name->fields['dept_name']){ 
                       ...
                       <td><?php echo $status[$rs_agent_name->fields['status_id']];?></td>
                       <td><?php echo $rs_agent_name->fields['priority_desc'];?></td> 
                       <td><?php echo ($rs_agent_name->fields['isoverdue'])?"Over Due":"In Time";?></td> 
                        <td><?php echo ($rs_agent_name->fields['is_overdue'])?"Over Due":"In Time";?></td> 
                       </tr>
               ...
               //$found_rows			   
				?>
				   ...
				   'call_center_crm_detailed_report.php?fdate='.$fdate.'&tdate='.$tdate.'&products='.$product_id
...
<form name="xForm2" id="xForm2" action="/convex_crm/export_call_center_crm_detailed_v2.php" method="post" class="middle-forms cmxform"  onSubmit="">
