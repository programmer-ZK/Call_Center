...
<?php
        $page_name = "ticket_priority_wise_pie_chart.php";
        $page_level = "0";
        $page_group_id = "0";
        $page_title = "Ticket Priority Wise Pie Chart";
        $page_menu_title = "Ticket Priority Wise Pie Chart";
?>
...
/*#ticket_priority_wise_pie_chart {
                       width: 100%;
                       height: 100%;
					   min-height:400px;
                       margin: 0;
...
<?php $rs_agent_name = $admin->ticket_priority_wise_pie_chart($fdate,$tdate);
      $ticket_priority_wise_pie_chart="";
...
<!-- ******************************  Agent On Call and Busy Times ************************** -->
	...
	<table class="table-short" id="keywords">
      			<thead>
      				<!--<tr>
	        	     <th colspan="3"><center><h4>Ticket Priority Wise Pie Chart</h4></center></th>
					</tr>-->
      			</thead>
      			<tbody>
                <tr>
                ...
                <?php  $ticket_priority_wise_pie_chart .= "['".trim($rs_agent_name->fields['priority_desc'])."',".($rs_agent_name->fields['rec'])."]," ?>  
                <?php 
				$rs_agent_name->MoveNext();
				}   ?>
                  <div id="ticket_priority_wise_pie_chart"></div>    
                </td>
                </tr>
                 <!-- <tr>
                	<td>
...
$(document).ready(function(){
	...
	//	alert('click');
		$('.hideme').hide();
	$('#ticket_priority_wise_pie_chart').show().printElement();	
	$('.hideme').show();
	});
...
anychart.onDocumentReady(function() {
 // create pie chart with passed data
  chart = anychart.pie([<?php echo $ticket_priority_wise_pie_chart;?>]);
  // set container id for the chart
  chart.container('ticket_priority_wise_pie_chart');
  // set chart title text settings
  chart.title('Ticket Priority Wise Pie Chart');
