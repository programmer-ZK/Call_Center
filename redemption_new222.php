...
function get_preview()
{
	...
	//var solution_type		= this.document.getElementById('solution_type').value;
...
// alert(unit_type);
		...
		//		percentage = this.document.getElementById('percentage_lbl').value;
			...
			else if(unit_type == "amount")
			{
				...
				//if(value > amount && value <= min_amount)
				if(value > amount)
				{
...
<li class="even">
						...
						<input type="hidden" id="solution_type" name="solution_type" value="<?php echo $solution_type; ?>">
							<?php 
...
<li class="even">
								...
								<label >
								 <input maxlength="10" name="unit_value" id="unit_value" class="txtbox-short" value="" onkeydown="return ( event.ctrlKey || event.altKey 
                    ...
                    || (event.keyCode==46)
					|| (event.keyCode==110)
					 )" onchange="javascript:get_validate(this.value)"/></label>&nbsp;&nbsp;<label class="field-title" id="unit_lbl" style="display:none; color:#FF0000"></label><label class="field-title" id="amount_lbl" style="display:none; color:#FF0000"></label><label class="field-title" id="percentage_lbl" style="display:none"></label>
...
<li >
          ...
          <span id="modeofpayment_error" class="form-error-inline" title = "Please Select Mode of Payment"   style="<?php  echo($modeofpayment_error); ?>"></span>
                            ...
                            <label>
         					 <input maxlength="20" name="city_name" id="city_name" class="txtbox-short" value="<?php echo $city_name_title; ?>">
						...
						<div id="bank_detail_div" style="display:none" >
							<li class="even">
								...
								<?php }else {?> <span id="bank_error" class="form-error-inline" title = "No Bank Details Founds">No Bank Details Founds </span> <?php } ?>	
