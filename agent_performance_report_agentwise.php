...
<?php
        $page_name = "agent_performance_report_agentwise.php";
        $page_level = "0";
        $page_group_id = "0";
        $page_title = "MY Performance Report";
        $page_menu_title = "My Performance Report";
?>
...
var search_keyword =  document.getElementById("userID").value;
...
//return popitup('report1.php?fdate='+fdate+'&search_keyword='+search_keyword+'&tdate='+tdate);
...
if(isset($_REQUEST['search_date']))
{
	...
	$search_keyword		= $_SESSION[$db_prefix.'_UserId'];//$_REQUEST['search_keyword'];
...
}else
{
	...
	$search_keyword = $_SESSION[$db_prefix.'_UserId'];//empty($_REQUEST["search_keyword"])?"":$_REQUEST["search_keyword"];
	...
	<table>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" value="<?php echo $_SESSION[$db_prefix.'_UserId']; ?>" id="userID" name="userID" />
			</td>
		</tr>
	</table>
	</h4>
