				...
				<fieldset>
					...
					<ol>
                        ...
                        <li class="even">
							...
							<?php /*?><label for="_register_num"><input type="radio" id="_register_num" name="type" value="register_num" <?php echo (@$_POST['type']=='register_num')?'checked':"";?>/>Registration Number</label> <?php */?>
                            <br>
   ...
   $('document').ready(function(e) {
    $('input[type=radio]').change(function(){
		if($(this).attr('id')=="_client_name"){
			...
			$('#_search').attr('placeholder','Alphabets Only');
			}else{
			$('#_search').attr('pattern','[0-9]+');
			$('#_search').attr('placeholder','Numbers Only');
			}
